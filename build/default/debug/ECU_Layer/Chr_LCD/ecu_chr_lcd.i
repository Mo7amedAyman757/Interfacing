...
# 149 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
STD_ReturnType lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd, uint8 row, uint8 col, const uint8 _chr[], uint8 mem_pos) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == lcd) {
        ret = (STD_ReturnType)0x00;
...
STD_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 col) {
    ...
    col--;
    switch (row) {
        case 1: ret = lcd_8bit_send_command(lcd, (0x80 + col));
            break;
        case 2: ret = lcd_8bit_send_command(lcd, (0xC0 + col));
            break;
        case 3: ret = lcd_8bit_send_command(lcd, (0x94 + col));
            break;
        case 4: ret = lcd_8bit_send_command(lcd, (0xD0 + col));
            break;
    }
