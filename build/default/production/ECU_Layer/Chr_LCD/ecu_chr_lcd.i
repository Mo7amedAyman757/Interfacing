...
# 143 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
STD_ReturnType lcd_4bit_send_string_pos(const chr_lcd_4bit_t *lcd, uint8 row, uint8 col, uint8 *str) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == lcd) {
        ret = (STD_ReturnType)0x00;
...
# 169 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
STD_ReturnType lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd, uint8 row, uint8 col, const uint8 _chr[], uint8 mem_pos) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    uint8 lcd_counter = 0;
    if (((void*)0) == lcd) {
...
# 272 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
STD_ReturnType lcd_8bit_send_char_data_pos(const chr_lcd_8bit_t *lcd, uint8 row, uint8 col, uint8 data) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == lcd) {
        ret = (STD_ReturnType)0x00;
...
STD_ReturnType lcd_send_4bits(const chr_lcd_4bit_t *lcd, uint8 _command) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if (((void*)0) == lcd) {
        ret = (STD_ReturnType)0x00;
    } else {
...
STD_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 col) {
    ...
    if (((void*)0) == lcd) {
        ...
        col--;
        switch (row) {
            case 1: lcd_8bit_send_command(lcd, (0x80 + col));
                break;
            case 2: lcd_8bit_send_command(lcd, (0xC0 + col));
                break;
        }
    }
    return ret;
...
STD_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 col) {
    ...
    if (((void*)0) == lcd) {
        ...
        col--;
        switch (row) {
            case 1: lcd_4bit_send_command(lcd, (0x80 + col));
                break;
            case 2: lcd_4bit_send_command(lcd, (0xC0 + col));
                break;
        }
    }
    return ret;
