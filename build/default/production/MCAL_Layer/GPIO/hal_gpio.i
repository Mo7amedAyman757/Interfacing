...
STD_ReturnType gpio_pin_read_logic(const pin_config_t *pin_config, logic_t *logic_status) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if ((((void*)0) == pin_config) || (((void*)0) == logic_status) || (pin_config->pin > 8 - 1)) {
        ret = (STD_ReturnType)0x00;
    } else {
        *logic_status = ((*port_registers[pin_config->port] >> pin_config->pin) & (uint8)1);
    }
    return ret;
}
...
STD_ReturnType gpio_pin_toggle_logic(const pin_config_t *pin_config) {
    ...
    if ((((void*)0) == pin_config) || (pin_config->pin > 8 - 1)) {
        ...
        (*port_registers[pin_config->port] ^= (1 << pin_config->pin));
    }
    return ret;
}
...
# 221 "MCAL_Layer/GPIO/hal_gpio.c"
STD_ReturnType gpio_port_read_logic(port_index_t port, uint8 *logic) {
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if ((port > 5 - 1)) {
        ret = (STD_ReturnType)0x00;
